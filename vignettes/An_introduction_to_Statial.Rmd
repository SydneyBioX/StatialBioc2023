...
2.  Does the relationship between T cell CD20 expression and B cell proximity occur across many images?
3.  Why are many of the strong relationships occurring in image 35? Configure the parameters of `plotStateChanges` to examine some these most significant interactions.
:::
