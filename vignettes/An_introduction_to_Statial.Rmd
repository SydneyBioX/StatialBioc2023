...
3.  Can you try find an interaction where the coefficient is positive? i.e. marker expression in the `to` cell type rises as distances increases from the `from` cell type.
:::
...
<img src="images/Contamination.png" alt="Contamination" style="border: 0px"/>
...
Similar to `Kontextual`, we can also plot the Kaplan-Meier curve to visualise the interaction most significantly correlated with survival outcome. Localisation here refers toincreased HLA class I expression in patients with localised populations of keratin/tumour and mesenchymal cells, whilst dispersion would mean increased HLA class I expression in patients with dispersed populations of keratin/tumour and mesenchymal cells.

As shown, increased HLA class I expression in keratin/tumour cells near mesenchymal cell populations tends to worsen survival outcomes, whilst increased HLA class I expression in keratin/tumour cells away from mesenchymal cells appears to improve survival outcomes.

::: question
**Question**

1.  Are there any relationships where localisation improves patient survival outcomes?
2.  Which ones are they? Do they make biological sense?
:::
